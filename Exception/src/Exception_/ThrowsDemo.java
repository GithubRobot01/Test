...
public class ThrowsDemo  {
    ...
    如果路径不是"C:\\a.txt",,那么我们就抛出异常对象,告知方法的调用者
    ...
    public static void readFile (String fileName) throws IOException {
        if (!fileName.equals("C:\\a.txt")) {
            throw new FileNotFoundException("找不到路径C:\\\\a.txt");
        }
